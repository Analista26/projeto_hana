...
tipo_execucao = "classe"  # opções: "produto", "bp_fornecedor", "classe", "bp_cliente" "equipamento" "centro_trabalho" "local_instalacao" 
# "caracteristicas" # # XXX AJUSTE AQUI XXX 
...
colunas_equivalentes = {
    "LIFNR": ["LIFNR", "PARTNER", "ALTKN", "LIFN2"], # Fornecedor
    "KUNNR": ["KUNNR", "CUSTOMER", "PARTNER", "PARNR"], # Cliente
    "MATNR": ["MATNR", "PRODUCT"], # Material
    "EQUNR": ["EQUNR"], # Equipamento
    "OBJID": ["OBJID"], # Centro de trabalho
    "ATNAM" : ["ATNAM"], # Caracterisitica
    "CLASS" : ["CLASS"], # Caracterisitica
...
caminhos_config = {
    ...
    "caracteristicas": {
        "planilha_mapeamento": 'Z:/00 Pastas de trabalho/Asantos/01 - Mapeamento/Mapeamento_Caracteristicas.xlsx',
        "arquivo_destino": 'Z:/00 Pastas de trabalho/Asantos/06 - Template Limpo/Template_limpo_Excel/EXP.MIG.LAY.MM-MM02_Caracteristicas.xlsx',
        "arquivo_destino_preenchido": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/EXP.MIG.LAY.MM-MM02_Caracteristicas_Preenchido.xlsx',
        "arquivo_destino_preenchido_LP": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/EXP.MIG.LAY.MM-MM02_Caracteristicas_Preenchido_LP.xlsx',
        "arquivo_log": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/Logs/Log_EXP.MIG.LAY.MM-MM02_Caracteristicas_Preenchido.xlsx',
        "Lista_Carga": 'Z:/00 Pastas de trabalho/Asantos/08 - Lista_Carga/Caracteristicas/Lista_Carga_1.xlsx', # TESTE
        #"Lista_Carga": 'Z:/00 Pastas de trabalho/Asantos/08 - Lista_Carga/Produtos/Lista_Carga_1.xlsx', 

    },

    "classe": {
        "planilha_mapeamento": 'Z:/00 Pastas de trabalho/Asantos/01 - Mapeamento/Mapeamento_Classes.xlsx',
        "arquivo_destino": 'Z:/00 Pastas de trabalho/Asantos/06 - Template Limpo/Template_limpo_Excel/EXP.MIG.LAY.MM-MM01_Classe.xlsx',
        "arquivo_destino_preenchido": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/EXP.MIG.LAY.MM-MM01_Classe_Preenchido.xlsx',
        "arquivo_destino_preenchido_LP": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/EXP.MIG.LAY.MM-MM01_Classe_Preenchido_LP.xlsx',
        "arquivo_log": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/03 - Produto/Logs/Log_EXP.MIG.LAY.MM-MM01_Classe_Preenchido.xlsx',
        "Lista_Carga": 'Z:/00 Pastas de trabalho/Asantos/08 - Lista_Carga/Lista_Carga_Classe.xlsx', # TESTE
        #"Lista_Carga": 'Z:/00 Pastas de trabalho/Asantos/08 - Lista_Carga/Produtos/Lista_Carga_1.xlsx', 
...
def carregar_lista_carga(coluna_chave= coluna_chave_execucao):
    ...
    try:
        ...
        elif  coluna_chave == "ATNAM":
            codigos = codigos.astype(str).str.strip()
        elif  coluna_chave == "CLASS":
            codigos = codigos.astype(str).str.strip()    
