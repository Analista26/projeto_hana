...
caminhos_config = {
    "produto": {
        "planilha_mapeamento": 'Z:/00 Pastas de trabalho/Asantos/01 - Mapeamento/01 - MM - Materiais/Mapeamento_Material_SQL.xlsx',
    ...
    "bp_fornecedor": {
        "planilha_mapeamento": 'Z:/00 Pastas de trabalho/Asantos/09 - Demanda/Fonecedor_RE/Mapeamento_Fornecedor_K.xlsx',
        ...
        "arquivo_destino_preenchido": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/EXP.MIG.LAY.MM-BP01-BP_For_Preenchido_Par_PF.xlsx',
        "arquivo_destino_preenchido_LP": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/EXP.MIG.LAY.MM-BP01-BP_For_Preenchido_Par_PF_LP.xlsx',
        "arquivo_log": 'Z:/00 Pastas de trabalho/Asantos/05 - X_TEMPLATE_PREENCHIDO/Logs/Log_Processo_Fornecedor_Preenchido_Par_PF.xlsx',
    ...
    if usar_sql_server:
        ...
        with engine.connect() as conn:
            for tabela_origem, mappings in mapeamentos_por_tabela.items():
                ...
                if lista_carga:
                    # Consultar amostra de colunas da tabela atual para resolver coluna chave real
                    try:
                        df_sample = pd.read_sql_query(f"SELECT TOP 1 * FROM {tabela_origem}", conn)
                    except Exception as e:
                        if 'Invalid object name' in str(e):
                            print(f"[ERRO] Tabela '{tabela_origem}' não disponível no SQL Server.")
                        else:
                    ...
                    try:
                        ...
                        continue
                    """
                    # Resolver a coluna_chave real considerando exceções
                ...
                try:
                    ...
                    # Se coluna_chave_real existir nas colunas, converte para str
